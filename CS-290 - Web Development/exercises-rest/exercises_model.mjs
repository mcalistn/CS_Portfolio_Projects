 ...
 * @returns a Promise. Resolves into a JSON object.
 */
...
/**
 * Find all exercise with specified filter, projection, and limit
 * @returns a Promise. Resolves into a JSON object. 
*/
...
/**
 * Replace the name, number of reps, weight, unit, or date properties of the 
